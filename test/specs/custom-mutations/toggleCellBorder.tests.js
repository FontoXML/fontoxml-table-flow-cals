...
import TestTableDefinition from '../utils/TestTableDefinition.js';

import registerCustomXPathFunctions from '../utils/registerCustomXPathFunctions.js';
	...
	describe('mutation status', () => {
		...
		describe('setting borders', () => {
			it('sets active if you set the top border on the middle cell when all borders are present', () => {
				...
				evaluateXPathToNodes('descendant::entry', documentNode, blueprint).forEach(cell => {
